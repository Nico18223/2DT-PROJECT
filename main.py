                ...
                if inpt3 == "A":
                  ...
                  if inpt4 == "A":
                    ...
                    if inpt5 == "A":
                      t6.cancel()
                      pronoun()
                      avgprint('"Are you okay? You sound a little out of it"')
#---------------------------point split-------------------------------------
                      if f_point >= 5:
                        pronoun1()
                        slowerprint('"no pion\' tryna s-ve me \'m al-ry dead"')
...
#---------------------------point split-------------------------------------
                ...
                if inpt2 == "B":
                  pronoun1()
                  slowprint('"That\'s okay, we can figure it out together, yeah?"')
                  ...
                  if inpt4 == "A":
                    ...
                    f_point =- 1
                    pronoun()
                    slowprint('"Now, lets get this over with yeah?"')
                    pronoun()
                    slowprint('"Have you called with the intent of harming yourself?"')
                    pronoun1()
                    slowprint('"I-I , I g-guess-"')
                    pronoun()
                    slowprint('"You guess?"')
                    slowprint("[YOU HEAR A SNIFFLE]")
                    pronoun1()
                    slowprint('"I d\'nt know why I-I bothered calling, re\'lly"')
                    slowprint("[THEIR VOICE IS BECOMING PROGRESSIVELY MORE SLURRED]")
                    slowprint("[IS IT FROM CRYING OR...]")
                    slowprint("[YOU FEEL AS THOUGH SOMETHING IS VERY WRONG HERE]")
...
#---------------------------point split-------------------------------------
                      if f_point >= 5:
                        pronoun1()
                        slowprint('"I g\'ess I call\' with the intent after I- I-"')
                        slowprint("[IT IS GETTING INCREASINGLY DIFFICULT TO UNDERSTAND THEM]")
                        pronoun1()
                        slowprint('"I alr\'dy did i\'"')
                        slowprint("[YOU HAVE TO STRAIN TO HEAR THEM]")
                        print(" ")
                        slowprint("A: PANIC")
                        slowprint("B: CALM")
                        print(" ")
...
#-----------------------------------------------G
                    ...
                    f_point =+ 1
                    pronoun()
                    slowprint('"Now, before we get into the gritty stuff"')
                    pronoun()
                    slowprint('"I want you to know that I am proud of you for reaching out, okay?"')
                    pronoun()
                    slowprint('"It takes a lot of courage to do something like this')
                    pronoun1()
                    slowprint('"......"')
                    pronoun1()
                    slowerprint('"Not r\'elly"')
                    pronoun1()
                    slowerprint('"I\'m a coward"')
                    slowprint("[THEIR VOICE SOUNDS SLURRED]")
                    slowprint("[YOU FEEL AS THOUGH SOMETHING ISN'T QUITE RIGHT HERE]")
...
#---------------------------point split-------------------------------------
                ...
                if inpt2 == "C":
                  pronoun()
                  slowprint('"That\'s okay! We don\'t always have to know everything"')
                  pronoun()
                  slowprint('"However, I do have to ask some mandatory questions"')
...
#-----------------------------------------------G
                    ...
                    f_point =+ 1
                    pronoun()
                    slowprint('"If you feel uncomfortable with them, just let me know, okay?"')
                    pronoun1()
                    slowprint('".... Okay"')
                    pronoun()
                    slowprint('"Great! Okay, first question: "')
                    pronoun()
                    slowprint('"Have you called with the belief that you are at risk of harming yourself?"')
                    pronoun1()
                    slowerprint('"..."')
                    slowprint("[THEY TAKE A DEEP BREATH]")
                    pronoun1()
                    slowerprint('"Ye-yes"')
                    pronoun()
                    slowprint('"Okay, thank you for telling me"')
                    pronoun()
                    slowprint('"Admitting that to a stranger takes a lot of courage"')
                    slowprint("[A HICCUP COMES FROM THE RECIEVER]")
                    pronoun1()
                    slowerprint('"\'m not brave"')
                    slowprint("[THEIR VOICE SOUNDS A LITTLE SLURRED]")
                    slowprint("[IT'S SUBTLE, BUT YOU KNOW YOU'RE NOT IMAGINING IT]")
                    pronoun1()
                    slowerprint('"\'m a cow-rd"')
                    slowprint("[IT'S BECOMING MORE DIFFICULT TO HEAR THEM]")
...
#---------------------------point split-------------------------------------
                      ...
                      f_point += 1
                      pronoun()
                      slowprint('"You are not a coward"')
